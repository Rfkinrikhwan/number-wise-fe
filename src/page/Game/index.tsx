...
export default function Games() {
    ...
    return (
        <div className={`relative flex min-h-screen w-full flex-col items-center justify-center overflow-hidden rounded-lg border ${theme === 'dark' ? 'bg-wise-dark' : ''} md:shadow-xl`}>
